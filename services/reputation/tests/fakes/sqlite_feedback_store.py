...
class SqliteFeedbackStore:
    ...
    def insert_feedback(
        ...
        *,
        ...
        Args:
            force_visible: If True, the record is immediately visible (e.g.
                platform-submitted ruling feedback that bypasses sealed rules).
        ...
        with self._lock:
            try:
                ...
                initial_visible = 1 if force_visible else 0
                self._db.execute(
                    """
                ...
                if not visible:
                    # Check for reverse pair (mutual reveal)
