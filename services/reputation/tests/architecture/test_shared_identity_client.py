...
class TestSharedIdentityClient:
    ...
    def test_platform_identity_client_extends_shared(self) -> None:
        """PlatformIdentityClient must subclass the shared IdentityClient."""
        ...
        assert shared_import, (
            "platform_identity_client.py must import IdentityClient from service_clients.identity"
        )
